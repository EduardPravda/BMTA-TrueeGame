...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvBoard.layoutManager = GridLayoutManager(this, cols)
        ...
        btnBackIngame.setOnClickListener { finish() }
    }
}